...
const config: MenuEntry[] = [
  ...
  // },
  {
    ...
    items: [
      ...
      {
        label: 'Vfat Tools',
        href: 'https://vfat.tools/polygon/Polypig/',
      },
      {
        label: 'DappRadar',
        href: 'https://dappradar.com/polygon/defi/Polypig-finance',
      },
    ],
  },
  {
    ...
    items: [
      {
        label: 'Github',
        href: 'https://github.com/PolypigFinance',
      },
      {
        label: 'Docs',
        href: 'https://Polypigfinance.gitbook.io/Polypig/',
      },
    ],
  },
]
